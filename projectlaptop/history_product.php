            ...
            <table class="table table-hover table-bordered table-striped" id="sortable-table">
                ...
                <tbody>
                    ...
                    if (isset($_GET['transactionId'])) {
                        ...
                        // Now you have the $transactionId, and you can use it to retrieve product details related to this transaction.
                    
                        // Create a SQL query to retrieve product details based on the $transactionId
                        $sql = "SELECT p.ten_san_pham, p.don_gia, td.quantity FROM product p
                                RIGHT JOIN transaction_detail td ON p.id = td.product_id 
                        ...
                        // Output the product details in a table or other HTML structure
                        ...
                        echo "Transaction ID is not set in the URL.";
                    }
        ...
        $(document).ready(function () {
            $('#productNameFilter').on('input', function () {
                ...
                table.find('tbody > tr').each(function () {
                    var productName = $(this).find('td').eq(0).text().toLowerCase(); // Thay đổi chỉ số theo cấu trúc bảng của bạn
